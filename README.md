<p align="center">
   ...
   <a href="https://github.com/alphavenom99/Fire-X">
...
## Heroku salesforce error solution.
   ...
   - Your Forked Url is looking Like: `https://github.com/alphavenom99/Fire-X` ; YourGitName = Your Github Username.
   - Now use this url to deploy: `Heroku.com/deploy?template=your forked url here` e.g.  `heroku.com/deploy?template=https://github.com/alphavenom99/Fire-X`; Here we put YourGitName = maihindu.   
